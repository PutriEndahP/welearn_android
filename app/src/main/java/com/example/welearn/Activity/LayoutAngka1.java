...
public class LayoutAngka1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layout_angka1);
    }
}



    TextView title, textView, textRegister;cardView1, cardView2;

...
public class SoalAngkaLv1aActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_soal_angka_lv1a);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(SoalAngkaLv1aActivity.this, SoalAngkaLv4aActivity.class);
                startActivity(i);
            }
        });

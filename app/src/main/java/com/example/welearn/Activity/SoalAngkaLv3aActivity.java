...
public class SoalAngkaLv3aActivity extends AppCompatActivity {
    ...
    SignaturePad padsoalangka1, padsoalangka2, padsoalangka3, padjawabangka1;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_soal_angka_lv3a);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(SoalAngkaLv3aActivity.this, SoalAngkaLv4bActivity.class);
                startActivity(i);
            }
        });

...
public class SoalAngkaAdapter extends RecyclerView.Adapter<SoalAngkaAdapter.ViewHolder>{
    ...
    public SoalAngkaAdapter(Context context, List<ListSoalHuruf> data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.round_angka, parent, false);
